                    ...
                    <div class="login-form">
                        <div class="main-div main-center col-12">
                            <div class="panel text-center">
                                <h1 class="text-center title hammer redvintage">Admin Log In</h1>
                                <p class='whitecream'>Please enter your username and password</p>
                            </div>

                            <form id="Login" action="PHP/loginadmin.php" method="POST">

                                <div class="form-group">


                                    <input type="text" name="log_admin" class="form-control" id="inputUsername"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="log_admin_password" class="form-control" id="inputPassword"
